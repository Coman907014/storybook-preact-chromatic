...
var Router = (function (Component$$1) {
	...
	Router.prototype.canRoute = function canRoute (url) {
		var children = A$1(this.props.children);
...
var useSetTheme = function (theme) {
  var _a;
  ...
  var updateThemeColors = A(function (themeColors, rootStyle) {
  ...
  var updateTheme = A(function (selectedTheme) {
    var _a;

    var rootStyle = (_a = window.root) === null || _a === void 0 ? void 0 : _a.style;
    rootStyle.setProperty('--small', '650');

    if (Object.values(Themes).indexOf(selectedTheme) < 0) {
  ...
  }, [(_a = window.root) === null || _a === void 0 ? void 0 : _a.style]);
  y(function () {
    updateTheme(theme);
  }, [theme]);
  return {
...
export { App as default, useSetTheme };
